...
def tokenize(text):
    ...
    lemmated = [lemmatizer.lemmatize(w).strip() for w in tokens if w not in stopwords.words('english')]
...
#         'vect__ngram_range': ((1, 1), (1, 2)),
        'clf__n_neighbors': [5,10, 15,30,50 ], # the optemal n_neighbors number is 10
